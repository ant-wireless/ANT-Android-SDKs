 ...
 */
public class LayoutController_BloodPressureDeviceInfo implements Closeable
{
     ...
     */
    public LayoutController_BloodPressureDeviceInfo(LayoutInflater inflator, ViewGroup viewGroup_Parent, DeviceInfoMesg fitDevInfoMsg)
    {
        ...
        if((fitDevInfoMsg.getTimestamp() != null) && (!fitDevInfoMsg.getTimestamp().getTimestamp().equals(DateTime.INVALID)))
            textView_Timestamp.setText(fitDevInfoMsg.getTimestamp().toString());
        else
        ...
        //This value should always be 18 for ANT+ Blood Pressure Monitors
